...
export const environment = {
  ...
  firebase: {
    ...
    apiKey: 'AIzaSyBbDrbdlADT4ybcVgoZUTwx7-XeYNj8s7I',
    authDomain: 'utu-be.firebaseapp.com',
    databaseURL: 'https://utu-be.firebaseio.com',
    projectId: 'utu-be',
    storageBucket: 'utu-be.appspot.com',
    messagingSenderId: '346749165019',
    appId: '1:346749165019:web:a10400393eeeb6844f1bfe'
  }
};
